...
Create detailed content for each section (keep ## headers but avoid **bold** formatting):
...
ANALYSIS_DATA_END`;
      ...
      const response = await this.openai.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a senior business analyst and consultant. Create comprehensive, actionable business analysis with clean formatting for Notion. Use ## for section headers but avoid **bold** formatting within content. Be specific with real numbers, examples, and recommendations. Format content clearly with headers and bullet points. In key_insights, provide actual valuable data points from your analysis.',
          },
          {
            role: 'user',
            content: prompt,
